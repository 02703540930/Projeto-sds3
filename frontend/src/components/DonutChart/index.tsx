...
const DonutChart = () => {
    ...
    axios.get(`${BASE_URL}/sales/amount-by-seller`)
        .then(response => {
            ...
            chartData = { labels: myLabels, series: mySeries };       //charData recebe os myLabels e mySeries criados no map acima
            console.log(chartData)                                    //busca a resposta escrita no charData
        });
